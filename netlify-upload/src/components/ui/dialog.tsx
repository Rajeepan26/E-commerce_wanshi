...
type DialogContentProps = React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & {
  ...
  /** When false, hides the built-in close control (e.g. when using a navbar toggle instead). Default true */
...
>(
  (
    { className, overlayClassName, closeClassName, showCloseButton = true, children, ...props },
    ref,
  ) => (
    <DialogPortal>
